...
function Categorybutton() {
  return (
    <div className='mx-[11%]'>
            ...
            <div className="container d-flex justify-content-between flex-wrap pb-[10px] " style={{ marginTop: '30px' }}>
                <Link to='eggs'>
                <div className="btn mt-[15px] " style={{ backgroundColor: '#E8E8E8', width: '200px', height: '70px', fontSize: '20px', fontWeight: '700', textAlign: 'center' }}>
                ...
                <div className="btn mt-[15px] " style={{ padding: '0px', width: '200px', height: '70px', backgroundColor: '#1B0F2E', paddingTop: '3px' }}>
                    <img style={{ width: '200px' }} src="images/neupass icon.webp" alt="" />
                </div>
                </a>
                
                <Link to="fruits">
                <div className="btn mt-[15px] " style={{ backgroundColor: '#4C6020', width: '200px', height: '70px', fontSize: '20px', fontWeight: '700', color: 'white' }}>
                ...
                <div className="btn mt-[15px] " style={{ backgroundColor: '#E8E8E8', width: '200px', height: '70px', fontSize: '20px', fontWeight: '700', textAlign: 'center', paddingTop: '15px' }}>
                    COMBO STORE
                </div>
            </div>

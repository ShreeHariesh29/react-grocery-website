      ...
      <div className="row row-cols-1 row-cols-sm-2 row-cols-md-4 g-4" style={{ marginTop: '20px' }}>
            ...
            <div className="card-body space-y-1">
              ...
              <div className="d-flex justify-content-between align-items-center">
                <div className="btn-group">
                  <button type="button" style={{height: '28px'}} className="btn btn-sm btn-outline-secondary">View</button>
                  <button type="button" className=" flex btn btn-sm bg-yellow-300 hover:bg-yellow-100 btn-warning h-7"><img src={carticon} style={{ width: '20px' }} />ADD</button>
                </div>
        ...
        <div className="col transition duration-100 hover:shadow-2xl" id="bankone" style={{ width: '200px' }}>
          <div className="card shadow-sm">
            ...
            <div className="card-body space-y-1">
              <h3 className="fs-6 text-body-tertiary">Fresho</h3>
              <h3 className="fs-6 text-body-secondary">Fresho Mutton Shoulder - Boneless, 500 g</h3>
        ...
        <div className="col transition duration-100 hover:shadow-2xl" id="bankone" style={{ width: '200px' }}>
          <div className="card shadow-sm">
            ...
            <div className="card-body space-y-1">
              ...
              <h3 className="fs-6 text-body-secondary">La Carne Mutton Seekh Kebab - Net Weight 500g</h3>
        ...
        <div className="col transition duration-100 hover:shadow-2xl" id="bankone" style={{ width: '200px' }}>
          <div className="card shadow-sm">
            ...
            <div className="card-body space-y-1">
              <h3 className="fs-6 text-body-tertiary">Fresho</h3>
              <h3 className="fs-6 text-body-secondary">Fresho Chicken Leg - With Skin - Net Weight 250 g</h3>
        ...
        <div className="col transition duration-100 hover:shadow-2xl " id="bankone" style={{ width: '200px' }}>
          <div className="card shadow-sm">
            ...
            <div className="card-body space-y-1">
              <h3 className="fs-6 text-body-tertiary">Fresho</h3>
              <h3 className="fs-6 text-body-secondary">Fresho Farm Eggs - Brown, Quantity - 6 pcs</h3>
        ...
        <div className="col transition duration-100 hover:shadow-2xl" id="bankone" style={{ width: '200px' }}>
          <div className="card shadow-sm">
            ...
            <div className="card-body space-y-1">
              <h3 className="fs-6 text-body-tertiary">Fresho</h3>
              <h3 className="fs-6 text-body-secondary">Fresho Dry Fish Shark Cubes - Net Weight 80 g</h3>
        ...
        <div className="col transition duration-100 hover:shadow-2xl" id="bankone" style={{ width: '200px' }}>
          <div className="card shadow-sm">
            ...
            <div className="card-body space-y-1">
              <h3 className="fs-6 text-body-tertiary">Fresho</h3>
              <h3 className="fs-6 text-body-secondary">Fresho Chicken Wings - With Skin, 8-10 Pcs, 500 g</h3>
